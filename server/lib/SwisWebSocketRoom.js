...
class SwisWebSocketRoom
{
	constructor(roomId, peerWait, events)
	{
		// Debugs
		this._debug = debug('node-swis-server:SwisWebSocketRoom:' + roomId);
		this._debugerror = debug('node-swis-server:ERROR:SwisWebSocketRoom:' + roomId);
...
module.exports = SwisWebSocketRoom;
